...
function KochiResorts() {
    ...
    const handleNextImage = () => {
        document.getElementById('kochi').scrollLeft -= 1500
    }
    ...
    const fetchHoneyMoonPackage = async () => {
        const response = await axios.get('/packages/kochi');
        ...
        return (
            <div className=' pb-[400px] w-4/4 h-auto bg-[#EBEBEB]  '>
                <div className=' w-5/6 h-auto mx-auto '>
                    ...
                    <h1 className=' text-[105px] my-3 font-semibold flex gap-5'>Best Kochi Resorts <span><img src='' alt="" width={180} /></span></h1>
                </div>
