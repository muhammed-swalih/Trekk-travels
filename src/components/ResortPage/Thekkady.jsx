...
function ThekkadyResorts() {
    ...
    const handleNextImage = () => {
        document.getElementById('thekkady').scrollLeft -= 1500
    }
        ...
        return (
            <div className=' pb-[400px] w-4/4 h-auto bg-[#EBEBEB]  '>
                <div className=' w-5/6 h-auto mx-auto '>
                    ...
                    <h1 className=' text-[105px] my-3 font-semibold flex gap-5'>Best Thekkady Resorts <span><img src='' alt="" width={180} /></span></h1>
                </div>
                ...
                <div id='thekkady' className=' scroll-smooth flex gap-16 w-5/6 h-auto  my-20 mt-32 mx-auto overflow-scroll hide-scrollbar rounded-3xl'>
