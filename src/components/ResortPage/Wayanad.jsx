...
function WayanadResorts() {
    ...
    const handleNextImage = () => {
        document.getElementById('wayanad').scrollLeft -= 1500
    }
        ...
        return (
            <div className=' pb-[400px] w-4/4 h-auto bg-[#EBEBEB]  '>
                <div className=' w-5/6 h-auto mx-auto '>
                    ...
                    <h1 className=' text-[105px] my-3 font-semibold flex gap-5'>Best Wayanad Resorts <span><img src='' alt="" width={180} /></span></h1>
                </div>
                ...
                <div id='vagamon' className=' scroll-smooth flex gap-16 w-5/6 h-auto  my-20 mt-32 mx-auto overflow-scroll hide-scrollbar rounded-3xl'>
        ...
        <div className=' w-full h-auto bg-[#EBEBEB] mt-[-8px]'>
            <div className=' w-full h-auto bg-[#EBEBEB]  py-5'>
                <div className=' px-5'>
                    ...
                    <h1 className=' text-xl font-bold flex inline-flex gap-1'>Best Wayanad Resorts <span><img src='' alt="" width={30} /></span></h1>
