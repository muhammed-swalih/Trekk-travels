...
function WayanadResorts() {
    ...
    const fetchHoneyMoonPackage = async () => {
        const response = await axios.get('https://trekkbackend.fun/packages/wayanad');
        ...
        return (
            ...
            <div className=' flex w-[1150px] mx-auto  flex-col gap-3'>
                ...
                <div className='flex justify-between'>
                    <h1 className=' font-semibold text-4xl flex gap-2'>Best Wayanad Resort</h1>
                ...
                <div id='wayanad' className='relative scroll-smooth flex gap-3 overflow-scroll hide-scrollbar rounded-2xl mt-5'>
                    {resort.map((items) => {
