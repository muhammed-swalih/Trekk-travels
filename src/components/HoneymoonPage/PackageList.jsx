...
function PackageList() {
        ...
        return (
            <div className=' w-full min-h-screen h-auto bg-[#EBEBEB] pt-[450px] pb-[50px] '>
                ...
                <div className=' w-full h-auto text-center'>
                    <img className=' mx-auto' src={honeymoonPaper} alt="" width={3200} />
                </div>
                ...
                <div className=' flex flex-wrap w-[4300px] rounded-3xl mx-auto h-auto px-[50px] py-[50px]'>
                    {image.map((items) => {
                        ...
                        return (
                            <div className=' w-[1900px] rounded-3xl bg-black relative mx-auto my-[90px]'>
    ...
    return (
        <div className=' w-full h-auto bg-[#EBEBEB] mb-5 mt-[-31px]'>
